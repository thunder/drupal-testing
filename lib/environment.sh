...
THUNDER_TRAVIS_TEST_BASE_DIRECTORY=${THUNDER_TRAVIS_TEST_BASE_DIRECTORY:-/tmp/test/${THUNDER_TRAVIS_PROJECT_NAME}}

# The directory, where drupal will be installed, defaults to ${THUNDER_TRAVIS_TEST_BASE_DIRECTORY}/install
THUNDER_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY=${THUNDER_TRAVIS_DRUPAL_INSTALLATION_DIRECTORY:-${THUNDER_TRAVIS_TEST_BASE_DIRECTORY}/install}
