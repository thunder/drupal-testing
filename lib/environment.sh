...
THUNDER_TRAVIS_PROJECT_NAME=${THUNDER_TRAVIS_TEST_GROUP-$(echo ${THUNDER_TRAVIS_COMPOSER_NAME} | cut -d '/' -f 2)}
...
THUNDER_TRAVIS_LOCK_FILES_DIRECTORY=${THUNDER_TRAVIS_LOCK_FILES_DIRECTORY:-/tmp/finished-stages}
