...
_stage_run_tests() {
    ...
    local phpunit=${DRUPAL_TESTING_DRUPAL_INSTALLATION_DIRECTORY}/${composer_bin_dir}/paratest
    ...
    local runtest="php ${phpunit} -p4 --verbose=1 --functional --bootstrap ${docroot}/core/tests/bootstrap.php --configuration ${docroot}/core ${test_selection} ${project_location}"
